...
class StorySourceManager {
  static final List<Map<String, dynamic>> storySourcesData = [];
  static final List<Map<String, dynamic>> storySourcesData1 = [];

  static Future<void> fetchDataFromSpreadsheet() async {
    storySourcesData.clear();
    ...
    const range = "Stories!A2:C"; // Adjust the sheet name and range accordingly
